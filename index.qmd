...
## Machine Learning Engineer at [Weights & Biases](https://wandb.ai/) {.profile-title}
...
[W&B](https://wandb.ai/ayush-thakur)
:::

::: {.profile-buttons}
[Authoring](/authoring/){.btn-action .btn .btn-primary role="button"}
[Read My Blog](/blog/){.btn-action-primary .btn-action .btn .btn-success role="button"}
[View My Projects](/projects/){.btn-action .btn .btn-info role="button"}
[Talks & Courses](/talks/){.btn-action .btn .btn-secondary role="button"}
:::
:::
:::
...
::: {.highlight-card}
### [LLM Evaluation Framework](https://github.com/ayulockin/llm-eval-sweep)
...
[Explore All Courses & Talks](/talks/){.explore-link}
:::
:::
